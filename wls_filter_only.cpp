...
int main(int argc, char** argv)
{
    ...
    switch (loaded_disp.channels()) 
    {
        case 1:
            ...
            break;
        case 3:
            cvtColor(loaded_disp, disp_single, COLOR_BGR2GRAY);

            break;
        case 4:
            cvtColor(loaded_disp, disp_single, COLOR_BGRA2GRAY);
    ...
    {
        case CV_8U:
            disp_single.convertTo(left_disp, CV_16S, 16.0);

            break;
        case CV_16U:
            disp_single.convertTo(left_disp, CV_16S, 1.0);

            break;
        case CV_16S:
            left_disp = disp_single;
